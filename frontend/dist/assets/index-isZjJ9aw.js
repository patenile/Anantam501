...
function bi(e, t, n) {
  ...
  for (r in t) Ec.call(t, r) && !xc.hasOwnProperty(r) && (l[r] = t[r]);
  if (e && e.defaultProps)
    ...
    (e.unstable_scheduleCallback = function (C, N, z) {
      ...
      return (
        ...
        z > W
          ...
          : ((C.sortIndex = G), t(s, C), S || w || ((S = !0), vl(g))),
        C
      );
    }),
...
function bc(e, t, n, r, l) {
  switch (t) {
    ...
    case "pointerover":
      var u = l.pointerId;
      return jn.set(u, dn(jn.get(u) || null, e, t, n, r, l)), !0;
    case "gotpointercapture":
      return (
...
function qu(e, t, n, r) {
  if (Dr) {
    var l = cu(e, t, n, r);
    if (l === null) jl(e, t, r, Ir, n), Yo(e, r);
...
var Ir = null;
function cu(e, t, n, r) {
  if (((Ir = null), (e = Xu(r)), (e = St(e)), e !== null))
...
var un = {
  ...
  Zo = we(nl),
  lf = $({}, nl, { dataTransfer: 0 }),
  uf = we(lf),
  of = $({}, Zn, { relatedTarget: 0 }),
  Nl = we(of),
  sf = $({}, un, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  af = we(sf),
  cf = $({}, un, {
...
var yf = $({}, Zn, {
  ...
  kf = we(Sf),
  Ef = $({}, un, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Cf = we(Ef),
  xf = $({}, nl, {
    deltaX: function (e) {
...
var Nf = Qe && "TextEvent" in window && !xn,
  Ds = Qe && (!no || (xn && 8 < xn && 11 >= xn)),
  bo = " ",
  ei = !1;
function Is(e, t) {
  switch (e) {
...
function Mf(e, t, n) {
  e === "focusin"
    ? (ri(), (_n = t), (Fn = n), _n.attachEvent("onpropertychange", Vs))
    : e === "focusout" && ri();
}
function jf(e) {
  ...
  ws(function () {
    ...
    e: {
      ...
      if (p !== void 0) {
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              v !== null &&
              ((d = v),
              f !== null && ((v = Mn(a, f)), v != null && k.push(Vn(a, v, d)))),
            M)
          )
            break;
          a = a.return;
        ...
        0 < k.length &&
          ((p = new w(p, S, null, n, h)), m.push({ event: p, listeners: k }));
      }
    }
    if (!(t & 7)) {
      e: {
        ...
        if (
          ...
          if (
            ...
            t: {
              for (k = w, f = S, a = 0, d = k; d; d = Ot(d)) a++;
...
function ht() {
  if (!Il && $e !== null) {
    ...
    try {
      ...
      throw ($e !== null && ($e = $e.slice(e + 1)), Cs(Gu, ht), l);
    } finally {
      (O = t), (Il = !1);
    }
  }
...
function bs(e, t, n) {
  (ke[Ee++] = Be), (ke[Ee++] = He), (ke[Ee++] = Pt), (Pt = e);
  var r = Be;
  e = He;
  var l = 32 - Oe(r) - 1;
  (r &= ~(1 << l)), (n += 1);
...
function na(e) {
  ...
  function h(f, a, d, v, g) {
    return a === null || a.tag !== 7
      ? ((a = xt(d, f.mode, v, g)), (a.return = f), a)
      : ((a = l(a, d)), (a.return = f), a);
  }
  function m(f, a, d) {
  ...
  function p(f, a, d, v) {
    ...
    if (typeof d == "object" && d !== null) {
      switch (d.$$typeof) {
        ...
        case Je:
          return (g = d._init), p(f, a, g(d._payload), v);
      }
      if (wn(d) || cn(d)) return g !== null ? null : h(f, a, d, v, null);
      pr(f, d);
    }
    return null;
  }
  function w(f, a, d, v, g) {
    if ((typeof v == "string" && v !== "") || typeof v == "number")
      return (f = f.get(d) || null), i(a, f, "" + v, g);
    if (typeof v == "object" && v !== null) {
      switch (v.$$typeof) {
        case nr:
          return (f = f.get(v.key === null ? d : v.key) || null), s(a, f, v, g);
        case Mt:
          return (f = f.get(v.key === null ? d : v.key) || null), c(a, f, v, g);
        case Je:
          var x = v._init;
          return w(f, a, d, x(v._payload), g);
      }
      if (wn(v) || cn(v)) return (f = f.get(d) || null), h(a, f, v, g, null);
      pr(a, v);
    }
    return null;
  }
  function S(f, a, d, v) {
    for (
      var g = null, x = null, _ = a, P = (a = 0), H = null;
      _ !== null && P < d.length;
      P++
    ) {
    ...
    if (P === d.length) return n(f, _), U && gt(f, P), g;
    if (_ === null) {
      for (; P < d.length; P++)
        (_ = m(f, d[P], v)),
          _ !== null &&
            ((a = u(_, a, P)), x === null ? (g = _) : (x.sibling = _), (x = _));
      return U && gt(f, P), g;
    }
  ...
  function k(f, a, d, v) {
    ...
    for (
      var x = (g = null), _ = a, P = (a = 0), H = null, T = d.next();
      _ !== null && !T.done;
      P++, T = d.next()
    ) {
      _.index > P ? ((H = _), (_ = null)) : (H = _.sibling);
      ...
      e && _ && Ne.alternate === null && t(f, _),
        (a = u(Ne, a, P)),
        x === null ? (g = Ne) : (x.sibling = Ne),
        (x = Ne),
        (_ = H);
    }
    if (T.done) return n(f, _), U && gt(f, P), g;
    if (_ === null) {
      for (; !T.done; P++, T = d.next())
        (T = m(f, T.value, v)),
          T !== null &&
            ((a = u(T, a, P)), x === null ? (g = T) : (x.sibling = T), (x = T));
      return U && gt(f, P), g;
    }
...
function po(e, t) {
  switch ((j(Hn, t), j(Bn, e), j(Ae, qn), (e = t.nodeType), e)) {
    case 9:
    case 11:
...
function Al(e) {
  ...
  if (((e = n.interleaved), e !== null)) {
    l = e;
    do (u = l.lane), (V.lanes |= u), (zt |= u), (l = l.next);
    while (l !== e);
...
function ka(e, t, n) {
  return Nt & 21
    ? (je(n, t) || ((n = Ps()), (V.lanes |= n), (zt |= n), (e.baseState = !0)),
      t)
...
function Li(e, t, n, r, l) {
  ...
  if ((Gt(t, l), t.stateNode === null))
    Pr(e, t), Pa(t, n, r), Cu(t, n, r, l), (r = !0);
  else if (e === null) {
    var o = t.stateNode,
      i = t.memoizedProps;
    o.props = i;
...
function Ma(e, t, n) {
  ...
  if (u) {
    ...
    return (
      ...
      i !== null ? (u = ct(i, u)) : ((u = xt(u, o, n, null)), (u.flags |= 2)),
      (u.return = t),
      (r.return = t),
      (r.sibling = u),
      (t.child = r),
...
function id(e, t, n, r, l, u, o) {
  if (n)
    return t.flags & 256
      ? ((t.flags &= -257), (r = $l(Error(y(422)))), mr(e, t, o, r))
      : t.memoizedState !== null
...
function ad(e, t, n) {
  ...
  switch ((uo(t), t.tag)) {
        ...
        (e === null || e.child === null) &&
          (dr(t)
            ...
            : e === null ||
              ...
              ((t.flags |= 1024), Re !== null && (Fu(Re), (Re = null)))),
        Lu(e, t),
        ne(t),
        null
      );
    ...
    case 13:
      if (
        ...
        if (U && he !== null && t.mode & 1 && !(t.flags & 128))
          ...
          ne(t), (u = !1);
        } else Re !== null && (Fu(Re), (Re = null)), (u = !0);
    ...
    case 17:
      return de(t.type) && Ar(), ne(t), null;
    case 19:
      if ((F(A), (u = t.memoizedState), u === null)) return ne(t), null;
...
function dd(e, t) {
  ...
  for (mu = { focusedElem: e, selectionRange: n }, Dr = !1, E = t; E !== null; )
...
function Ua(e) {
  ...
  t !== null && ((e.alternate = null), Ua(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Fe], delete t[$n], delete t[yu], delete t[Xf], delete t[Gf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
          ...
          for (E = l; E !== null; )
            (o = E),
              ...
              o.tag === 22 && o.memoizedState !== null
                ...
                ? ((s.return = o), (E = s))
                : Fi(l);
        for (; u !== null; ) (E = u), Ba(u), (u = u.sibling);
        (E = l), (hr = i), (re = c);
      }
      Di(e);
    } else
      l.subtreeFlags & 8772 && u !== null ? ((u.return = l), (E = u)) : Di(e);
  }
}
function Di(e) {
  for (; E !== null; ) {
...
function Ha(e, t) {
  ...
  if (r & 30 || r & e.expiredLanes || t) t = qr(e, r);
    ...
    R |= 2;
    var u = Qa();
    (J !== e || b !== t) && ((Ve = null), (rn = Q() + 500), Ct(e, t));
    do
      try {
        yd();
        break;
  ...
  if (t !== 0) {
    ...
    if (t === 6) et(e, r);
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            (et(e, r), (r & 130023424) === r && ((t = xo + 500 - Q()), 10 < t))
          ) {
            if (jr(e, 0) !== 0) break;
...
function Lr(e, t, n, r, l, u) {
  ...
  if (((r = e), typeof e == "function")) zo(e) && (o = 1);
    ...
    e: switch (e) {
      ...
      case Gl:
        return (e = Ce(19, n, t, l)), (e.elementType = Gl), (e.lanes = u), e;
      case os:
        return fl(n, l, u, t);
      default:
  ...
  return (
    (t = Ce(o, n, t, l)), (t.elementType = e), (t.type = r), (t.lanes = u), t
  );
}
function xt(e, t, n, r) {
...
function Rd() {
  const [e, t] = Se.useState("home"),
    ...
    [p, w] = Se.useState(""),
    [S, k] = Se.useState(""),
    [M, f] = Se.useState(null);
  function a(g) {
    return /.+@.+\..+/.test(g);
  }
  function d(g) {
    if ((g.preventDefault(), !a(n))) {
      c("Invalid email");
      return;
    }
    if (!l || !o) {
    ...
    c("Registration successful"), t("login");
  }
  function v(g) {
    g.preventDefault(),
      h === n && p === l ? (f({ name: o }), k("")) : k("Invalid credentials");
  }
  return M
    ? I.jsxs("div", {
        children: [
          I.jsxs("h1", { children: ["Welcome, ", M.name] }),
          I.jsx("button", { onClick: () => f(null), children: "Logout" }),
        ],
      })
    : I.jsxs("div", {
        children: [
          I.jsx("h1", {
            children:
              "Welcome to Anantam Home Interior Design Collaboration App",
          }),
          I.jsx("p", {
            children: "Your collaborative platform for home design.",
          }),
          I.jsx("div", { id: "mount-check", children: "[App Mounted]" }),
          I.jsxs("nav", {
            children: [
              I.jsx("button", {
                onClick: () => t("register"),
              ...
              I.jsx("button", { onClick: () => t("login"), children: "Login" }),
            ],
          }),
          e === "register" &&
            I.jsxs("form", {
              ...
              children: [
                ...
                I.jsx("button", { type: "submit", children: "Register" }),
                s && I.jsx("div", { children: s }),
              ],
            }),
          e === "login" &&
            I.jsxs("form", {
              ...
              children: [
                ...
                I.jsx("button", { type: "submit", children: "Login" }),
                S && I.jsx("div", { children: S }),
              ],
            }),
        ],
...
Ql.createRoot(document.getElementById("root")).render(
  I.jsx(gc.StrictMode, { children: I.jsx(Rd, {}) })
);
