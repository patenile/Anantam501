...
@deprecated(
    "Motor will be deprecated on May 14, 2026. Migration to the PyMongo Async driver is recommended."
)
async def apaginate(
...
@deprecated(
    "Use `apaginate_aggregate` instead. This function will be removed in v0.16.0"
)
