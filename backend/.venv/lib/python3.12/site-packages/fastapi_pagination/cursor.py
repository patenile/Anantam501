...
@overload
def decode_cursor(
    cursor: str | None, *, to_str: Literal[True] = True, quoted: bool = True
) -> str | None:
    pass
...
@overload
def decode_cursor(
    cursor: str | None, *, to_str: Literal[False], quoted: bool = True
) -> bytes | None:
    pass
...
@overload
def decode_cursor(
    cursor: str | None, *, to_str: bool, quoted: bool = True
) -> Cursor | None:
    pass


def decode_cursor(
    cursor: str | None, *, to_str: bool = True, quoted: bool = True
) -> Cursor | None:
    if cursor:
        try:
