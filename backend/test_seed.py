...
def seed():
    ...
    # Add test users
    users = [
        User(email="testuser1@example.com", hashed_password=hash_password("password1"), full_name="Test User 1", is_superuser=False),
        User(email="admin@example.com", hashed_password=hash_password("adminpass"), full_name="Admin User", is_superuser=True),
    ]
